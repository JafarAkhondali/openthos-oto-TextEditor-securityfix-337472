...
import org.openthos.android.file_explorer.adapter.FileListPagerAdapter;
import org.openthos.android.file_explorer.databinding.FileExplorerActivityBinding;
import org.openthos.android.file_explorer.io.JecFile;
import org.openthos.android.file_explorer.io.LocalFile;
import org.openthos.android.file_explorer.listener.OnClipboardDataChangedListener;
import org.openthos.android.file_explorer.util.FileListSorter;
import org.openthos.common.app.JecApp;
...
import org.openthos.editor.FullScreenActivity;
...
//        activity.startActivityForResult(it, requestCode);
        ...
        intent.putExtra("mode", MODE_PICK_PATH);
        intent.putExtra("type", "save");
        intent.putExtra("dest_file", destFile);
