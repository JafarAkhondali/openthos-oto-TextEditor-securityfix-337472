...
import com.openthos.common.github.Issue;
import com.openthos.common.github.IssueService;
...
public class FeedbackActivity extends BaseActivity {
    ...
    private void submit() {
        ...
        if (!SysUtils.isNetworkAvailable(this)) {
            UIUtils.toast(this, com.openthos.common.R.string.network_unavailable);
            return;
        }
