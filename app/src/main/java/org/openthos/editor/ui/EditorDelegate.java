...
import org.openthos.editor.interfaces.OnVisibilityChangedListener;
import org.openthos.editor.interfaces.SaveListener;
import org.openthos.editor.ui.dialog.DocumentInfoDialog;
import org.openthos.editor.ui.dialog.FinderDialog;
import org.openthos.editor.utils.AppUtils;
import org.openthos.editor.view.EditorView;
import org.openthos.editor.view.menu.MenuDef;
import org.openthos.editor.widget.text.EditAreaView;
...
public class EditorDelegate implements OnVisibilityChangedListener, OnTextChangeListener {
    ...
    public void onLoadFinish() {
        ...
        if (!"org.openthos.editor_area.v2".equals(context.getPackageName())) {
            mEditText.setEnabled(false);
        }
        loaded = true;
